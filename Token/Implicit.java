...
public class Implicit extends Links
{
	...
	protected LinkedList<String> id = new LinkedList<String>();
	...
	public void LinkLabel(String defLinkLabel)
	{
		...
		//make id
		id.add(tempUrl.substring(tempUrl.indexOf("[")+1, tempUrl.indexOf("]")));
	...
	public String generate()
	{
		...
		else
		{
			...
			{
				link_text = iterator.next();
				
				if(link_text.equals(link_text))
				{
